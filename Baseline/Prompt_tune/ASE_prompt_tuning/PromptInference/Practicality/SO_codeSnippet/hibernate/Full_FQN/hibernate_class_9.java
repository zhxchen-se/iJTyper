public class hibernate_class_9 implements java.io.Serializable {
  ...
  public static void load(org.hibernate.Session session, java.util.List<java.lang.String> values) {
    ...
    hibernate_class_9.setPatientId(int)
    hibernate_class_9.setPatientName(java.lang.String)
    hibernate_class_9.setProviderId(java.lang.String)
    org.hibernate.Session.save(hibernate_class_9)
  }
