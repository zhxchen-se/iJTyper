public class hibernate_class_17 {
    public class SessionFactoryImpl {
        ...
        public org.hibernate.SessionFactory createSessionFactory() throws javax.naming.NamingException {
            org.hibernate.cfg.Configuration prototypeConfig = new org.hibernate.cfg.Configuration().configure(hibernate_class_17.SessionFactoryImpl.SHARD_CFG_0);
            prototypeConfig.addResource(hibernate_class_17.SessionFactoryImpl.SHARDED_TABLE);
            ...
            shardConfigs.add(buildShardConfig(hibernate_class_17.SessionFactoryImpl.SHARD_CFG_0));
            shardConfigs.add(buildShardConfig(hibernate_class_17.SessionFactoryImpl.SHARD_CFG_1));
