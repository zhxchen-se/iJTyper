public class hibernate_class_46 {
    ...
    private static hibernate.hibernate_class_46 me;
    ...
    public org.hibernate.Session currentSession() throws java.lang.Exception {
        org.hibernate.Session s = ((org.hibernate.Session) (hibernate.hibernate_class_46.session.get()));
        if (s != null) {
            s.setCacheMode(CacheMode.REFRESH);
        }
        if (s == null) {
            s = hibernate.hibernate_class_46.openSession();
            hibernate.hibernate_class_46.session.set(s);
        }
        return s;
    }
