public class xstream_class_44 {
    ...
    public static void main(java.lang.String[] args) {
        try {
            ...
            x.alias("testObject", xstream_class_44.TestObject.class);
    ...
    public static xstream_class_44.TestObject getNewTestObject() {
        ...
        orderRecord.setName("OBJECT_" + xstream_class_44.COUNT);
        while ((xstream_class_44.COUNT++) < xstream_class_44.MAX_DEPTH) {
            orderRecord.setParentObject(xstream_class_44.getNewTestObject());
        } 
        return orderRecord;
    }
