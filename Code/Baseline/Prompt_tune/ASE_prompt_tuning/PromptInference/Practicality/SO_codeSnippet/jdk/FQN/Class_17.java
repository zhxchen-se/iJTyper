public class Class_17 {
    public static void main(java.lang.String[] arg) {
        ...
        java.time.temporal.TemporalAccessor temporal = java.time.format.DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss.S").parse(date);// use parse(date, LocalDateTime::from) to get LocalDateTime
