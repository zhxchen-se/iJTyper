public class xstream_class_5 {
    public class Test {
        public void main(java.lang.String[] args) throws java.io.FileNotFoundException {
            ...
            xstream.xstream_class_5.Foo f = new xstream.xstream_class_5.Foo(1, "booo", new xstream.xstream_class_5.Bar(42));
    ...
    public class Foo {
        ...
        public xstream.xstream_class_5.Bar boo;

        public Foo(int a, java.lang.String b, xstream.xstream_class_5.Bar c) {
            this.a = a;
            this.b = b;
            this.boo = c;
        }
