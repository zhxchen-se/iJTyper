...
public class hibernate_class_15 {
  ...
  public void setContentBlob(java.sql.Blob imageBlob) {
    this.content = hibernate_class_15.toByteArray(java.sql.Blob);
  }
  ...
  public java.sql.Blob getContentBlob() {
    return org.hibernate.Hibernate.createBlob(byte[]);
  }

  private byte[] toByteArray(java.sql.Blob fromBlob) {
    java.io.ByteArrayOutputStream baos = new java.io.ByteArrayOutputStream();
    try {
      return hibernate_class_15.toByteArrayImpl(java.sql.Blob,java.io.ByteArrayOutputStream);
  ...
  private byte[] toByteArrayImpl(java.sql.Blob fromBlob, java.io.ByteArrayOutputStream baos) throws java.sql.SQLException, java.io.IOException {
    ...
    java.io.InputStream is = java.sql.Blob.getBinaryStream();
    try {
      for (; ;) {
        int dataSize = java.io.InputStream.read(byte[]);
        if (dataSize == (-1))
          break;
