public class Android36 {
    ...
    private long insertRow(int rowParameter, java.lang.String rowValue, android.database.sqlite.SQLiteDatabase db) {
        ...
        settingsParameterValues.put(androidExamples.Android36.KEY_NAME, rowParameter);
        settingsParameterValues.put(androidExamples.Android36.VALUE, rowValue);
        if (db != null) {
            res = db.insert(androidExamples.Android36.DATABASE_TABLE, null, settingsParameterValues);
        }
        return res;
    }
